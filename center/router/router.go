...
func (rt *Router) Config(r *gin.Engine) {
	...
	pages := r.Group(pagesPrefix)
	{
		...
		pages.GET("/message-templates", rt.auth(), rt.user(), rt.perm("/message-templates"), rt.messageTemplatesGet)
		...
		pages.POST("/notify-channels", rt.auth(), rt.user(), rt.perm("/notify-channels/add"), rt.notifyRulesAdd)
		pages.DELETE("/notify-channels", rt.auth(), rt.user(), rt.perm("/notify-channels/del"), rt.notifyRulesDel)
		pages.PUT("/notify-channel/:id", rt.auth(), rt.user(), rt.perm("/notify-channels/put"), rt.notifyRulePut)
		pages.GET("/notify-channel/:id", rt.auth(), rt.user(), rt.perm("/notify-channels"), rt.notifyRuleGet)
		pages.GET("/notify-channel-configs", rt.auth(), rt.user(), rt.perm("/notify-channels"), rt.notifyRulesGet)
	}
